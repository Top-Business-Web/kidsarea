            ...
            <div class=" bill">
                ...
                <div class="info">
                    ...
                    <ul>
                        ...
                        <li><label> Print Time : </label> <strong> {{$date ->format('h:i ')}} </strong></li>
                        <!--<li><label style="font-weight: bold;"> Access time : </label> <strong style="font-weight: bold;"> {{$ticket->created_at}} </strong></li> -->
                        <li><label style="font-weight: bold;"> Access time : </label> <strong style="font-weight: bold;"> {{$ticket->created_at->format('h:i ')}} </strong></li>
                        <li><label style="font-weight: bold;"> Exit time : </label> <strong style="font-weight: bold;"> {{$ticket->created_at->addHours($ticket->hours_count)->format('h:i ')}} </strong></li>

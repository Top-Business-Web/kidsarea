                ...
                <div class="info">
                    ...
                    <ul>
                      ...
                      <!--  <li><label> Shop Name : </label> <strong>Kids station company</strong></li>
                        ...
                        <li><label> Payment Method : </label> <strong  style="font-weight: bold;"> {{$ticket->payment_method}} </strong></li>
                    </ul>
                </div>
...
<?php $p_vat = 0 ?>
                        ...
                        <li><label> Ticket Price : </label> <strong> <?php $ticket_price = 0;?>
                          <!-- @foreach($models as $model) <?php //($ticket_price+=$model->sum_all/1.14) ?> @endforeach {{round($ticket_price,2)}} -->
                          {{$ticket->ticket_price}} EGP</strong></li>{{--update--}}
                        @if($ticket->ent_tax != 0)
                            <li><label> Ent.Tax 20% : </label> <strong>   {{$ticket->ent_tax}} EGP</strong></li>
                        @endif
                       
                        @if($ticket->vat != 0)
                            <li><label> VAT 14% : </label> <strong> <?php $vat = 0;?>  @foreach($models as $model) <?php $vat+=($model->sum_all - ($model->sum_all/1.14)) ?> @endforeach {{round($vat,2)}} EGP</strong></li>{{--update--}}
                            <li><label> Total VAT 14% : </label> <strong>   <?php echo  $ticket->vat ?> EGP</strong></li>
                        @endif

            ...
            <div class=" bill">
                ...
                <div class="info">
                    ...
                    <ul>
                        ...
                        <li><label> Print Time : </label> <strong> {{$date ->format('h:i A')}} </strong></li>
                ...
                <div class="info">
                    ...
                    <ul>
                        ...
                        @endif
                        @if($ticket->ent_tax != 0)
                        <li><label> Ent.Tax 20% : </label> <strong>   {{round($ticket->ent_tax,2)}} EGP</strong></li>
                        @endif
                        @if($ticket->vat != 0)
                            <li><label> VAT 14% : </label> <strong>   {{$ticket->vat}} EGP</strong></li>
                        @endif
                        ...
                        <li><label> total price : </label> <strong>   {{$ticket->paid_amount}} EGP</strong></li>

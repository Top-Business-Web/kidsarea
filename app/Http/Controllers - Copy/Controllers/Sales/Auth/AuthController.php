...
class AuthController extends Controller
{
    ...
    public function uploadData(Request $request)
    {
       ...
       $dump = new IMysqldump\Mysqldump('mysql:host=2.57.89.1;dbname=u657893346_amc', 'u657893346_amc', 'Amc@2023');
         $dump = new IMysqldump\Mysqldump('mysql:host=localhost;dbname=amc', 'root', '');//local
       if (file_exists('database/' . date('Y-m-d') . '-u657893346_amc.sql')) {
        unlink('database/' . date('Y-m-d') . '-u657893346_amc.sql');
       }
       $dump->start('database/' . date('Y-m-d') . '-u657893346_amc.sql');

       $dbFile = public_path('database/' . date('Y-m-d') . '-u657893346_amc.sql');


    $dropMysqli = new mysqli('2.57.89.1', 'u657893346_amc', 'Amc@2023', 'u657893346_amc');//online
       ...
       $dropMysqli->query('SET foreign_key_checks = 1');
        $dropMysqli->close();
        new Import($dbFile, 'u657893346_amc', 'Amc@2023', 'u657893346_amc', '2.57.89.1');//online

        ...
        if ($request->ajax()) {
            ...
            foreach ($users as $user) {
                foreach ($paymentMethods as $paymentMethod) {
                    ...
                    $totalRev = 0;
                    $totalTicket = 0;
                    $reservation = Payment::latest()->whereDate('created_at','>=', $starting_date)->whereDate('created_at','<=', $ending_date);
...
//                    $ticket = ReturnAmount::latest()->whereDate('created_at', '>=', $starting_date);
                    $ticket = ReturnAmount::latest()->whereDate('created_at','>=', $starting_date)->whereDate('created_at','<=', $ending_date);
